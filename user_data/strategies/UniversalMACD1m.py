...
class UniversalMACD1m(IStrategy):
    ...
    # Strategy parameters
    buy_umacd_max = DecimalParameter(-0.05, 0.05, decimals=5, default=0.0121, space="buy")
    buy_umacd_min = DecimalParameter(-0.05, 0.05, decimals=5, default=-0.02571, space="buy")
    sell_umacd_max = DecimalParameter(-0.05, 0.05, decimals=5, default=0.03537, space="sell")
